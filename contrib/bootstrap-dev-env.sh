...
read -sp "Enter Docker Admin password for rakirahman.azurecr.io: " docker_password
echo
echo "$docker_password" | docker login rakirahman.azurecr.io --username rakirahman --password-stdin
